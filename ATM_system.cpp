...
void withdraw()
{
    ...
    do
    {
        ...
        cout << "Enter money you want to deposit: ";
        cin >> withdraw;
        if (withdraw < 20000 && withdraw % 500 == 0)
        {
            while (getline(read, line))
            {
                istringstream dd(line);
...
void administrator_add()
{
    ...
    addaccount << accout_addition.account_number << " " << accout_addition.pin << " " << accout_addition.balance << " " << accout_addition.status;
}
